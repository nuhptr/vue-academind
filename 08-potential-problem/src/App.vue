<script>
   ...
   export default {
      ...
      // Lifecycle hook same like useEffect in React
      mounted() {
         setTimeout(() => {
            this.topics.push({
               id: "new",
...
<template>
   <div>
      <ActiveElement :topicTitle="activeTopic && activeTopic.title" :text="activeTopic && activeTopic.fullText" />
      <KnowledgeBase />
   </div>
</template>
